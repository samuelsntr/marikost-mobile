...
class HomeSearchKost extends StatefulWidget {
  const HomeSearchKost({super.key});

  @override
  State<HomeSearchKost> createState() => _HomeSearchKostState();
}

class _HomeSearchKostState extends State<HomeSearchKost> {
              ...
              Container(
                ...
                decoration: const BoxDecoration(
                    ...
                    image: DecorationImage(
                        image:
                            AssetImage('assets/images/marikost_bg_kelola.jpg'),
                        fit: BoxFit.cover)),
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Image.asset('assets/images/marikost_logo.png', width: 70),
                      FutureBuilder(
                          ...
                          builder: (context, AsyncSnapshot<dynamic> snapshot) {
                            if (snapshot.hasData) {
                              ...
                              return Container(
                                ...
                                child: CircleAvatar(
                                  foregroundImage: profile['foto_profile'] !=
                                          null
                                      ? NetworkImage(
                    ...
                    Container(
                      ...
                      child: GridView.count(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              Navigator.pushNamed(context, '/jasa', arguments: {
                                "title": "MariClean",
                                "JasaId": 1,
                              });
                            },
